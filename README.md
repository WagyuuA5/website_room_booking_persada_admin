# Sistem Manajemen Ruangan & Pemesanan — PT PERSADA

Aplikasi internal berbasis Blazor Web App (.NET 10) untuk manajemen pemesanan ruangan rapat, fasilitas, tiket dukungan IT, laporan bug, log audit, dan konfigurasi sistem operasional PT PERSADA.
